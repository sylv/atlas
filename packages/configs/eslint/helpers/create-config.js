...
/** @type {(rules?: import('eslint').Linter.ConfigOverride) => import('eslint').Linter.Config} */
module.exports.createConfig = (override) => {
  if (!override.files) override.files = DEFAULT_FILES;
  ...
  if (override) {
    return {
      ...base,
      overrides: [...base.overrides, override],
    };
  }
